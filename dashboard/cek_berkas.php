...
<div class="card shadow mb-4">
    ...
    <form action="" method="GET">
        <input type="hidden" name="halaman" value="cek-berkas">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-4">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="dataTable" class="table table-bordered">
                ...
                <tbody>
                    <?php $nomor = 1; ?>
                    <?php $ambil = $koneksi->query("SELECT * FROM pelamar JOIN status ON pelamar.id_status = status.id_status WHERE pelamar.id_lowongan='$id_lowongan'"); ?>
